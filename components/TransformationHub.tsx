      ...
      <div className="w-full lg:max-w-[1440px] px-5 lg:px-[64px] mx-auto">
        <div className="bg-[#fdf2f3] rounded-[24px] p-8 lg:p-[80px] w-full flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4 max-w-4xl">
            <p className="text-[#0070c0] text-[16px] lg:text-[20px] italic font-semibold font-nunito-sans">
              Learning With Our CEO:
            </p>
            <h2
              id="transformation-hub-heading"
              className="text-[#571244] text-[28px] lg:text-[44px] italic font-bold leading-tight font-nunito"
            >
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-10 lg:gap-[60px] items-center">
            {/* Image Column */}
            <div className="relative w-full h-[300px] lg:w-[560px] lg:h-[340px] rounded-[8px] overflow-hidden shadow-xl">
              <Image
            ...
            <div className="flex flex-col gap-8">
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4" aria-label="Transformation Hub features">
                {hubFeatures.map((feature) => (
                  <li key={feature} className="bg-white rounded-[12px] p-5 flex items-center gap-4 shadow-sm border border-[#fce7e9]">
                    ...
                    <span className="text-gray-800 text-[15px] font-semibold font-nunito-sans">{feature}</span>
                  </li>
                ))}
              </ul>
              ...
              <Link 
                href="#" 
                className="inline-flex items-center justify-center bg-[#571244] text-white text-[15px] font-bold rounded-[4px] px-8 py-4 w-fit hover:bg-[#430e34] transition-colors gap-2 font-nunito-sans"
              >
                Learn More
