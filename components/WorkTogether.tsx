...
export default function WorkTogether() {
  return (
    ...
    >
      <div className="w-full lg:max-w-[1440px] px-5 lg:px-[64px] py-10 lg:py-[40px] flex flex-col lg:flex-row items-start lg:items-center lg:justify-between mx-auto gap-6 lg:gap-0 border-b-2 border-[#C4C4C4]">
